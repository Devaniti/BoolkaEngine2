...
namespace Filesystem
{
    ...
    public:
		...
		RecursiveDirectoryIterator(const std::filesystem::path& path, bool iterate_directories = false, bool iterate_files = true);
		...
		RecursiveDirectoryIterator& operator=(const RecursiveDirectoryIterator& other) = default;
		RecursiveDirectoryIterator& operator=(RecursiveDirectoryIterator&& other) = default;
	...
	[[nodiscard]] RecursiveDirectoryIterator begin(RecursiveDirectoryIterator iterator) noexcept;
	[[nodiscard]] RecursiveDirectoryIterator end(RecursiveDirectoryIterator) noexcept;
